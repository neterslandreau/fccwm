...
<form action="http://fccwm.us2.list-manage2.com/subscribe/post?u=66f03ba43600ea2123fefe17f&amp;id=7471cd7a54" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" style="font: normal 100% Arial, sans-serif;font-size: 10px;">
	<fieldset style="-moz-border-radius: 4px;border-radius: 4px;-webkit-border-radius: 4px;border: 1px solid #ccc;padding-top: 1.5em;margin: .5em 0;background-color: #fff;color: #000;text-align: left;">
	<legend style="white-space: normal;text-transform: capitalize;font-weight: bold;color: #000;background: #fff;padding: .5em 1em;border: 1px solid #ccc;-moz-border-radius: 4px;border-radius: 4px;-webkit-border-radius: 4px;font-size: 1.2em;"><span>FCCWM Mailing List</span></legend>
...
function mce_init_form(){
    jQuery(document).ready( function($) {
      ...
      options = { url: 'http://fccwm.us2.list-manage.com/subscribe/post-json?u=66f03ba43600ea2123fefe17f&id=7471cd7a54&c=?', type: 'GET', dataType: 'json', contentType: "application/json; charset=utf-8",
